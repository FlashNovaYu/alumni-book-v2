...
assert.match(messagesView, /togglePublicHide/)
assert.match(messagesView, /togglePublicPin/)
assert.match(messagesView, /togglePublicFeature/)
assert.match(messagesView, /removePublic/)
assert.match(messagesView, /审核人：/)
